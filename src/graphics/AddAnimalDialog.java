...
public class AddAnimalDialog extends JDialog implements ItemListener, ActionListener {
     ...
     * @param foodtype foodtype of animals
     */
    public AddAnimalDialog(String title, String foodtype)
    {
    ...
    public void actionPerformed(ActionEvent e)
    {
 		if(e.getSource() == ok)
		{
		    ZooPanel.getInstance().addAnimal(chosenAnimal,sl_sz.getValue(),sl_hor.getValue(),sl_ver.getValue(),c, foodtype);
		    setVisible(false);
		}
		else 
		    setVisible(false);
